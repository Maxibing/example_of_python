...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.la = QLabel("这里将会显示选择的按钮信息", self)
        self.la.move(20, 20)
    ...
    def info(self):
        reply = QMessageBox.information(self, "提示", "这是一个提示对话框", QMessageBox.Ok | QMessageBox.Close, QMessageBox.Close)
